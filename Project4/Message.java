...
public class Message implements Serializable {
	...
	ADDGROUP = 10,      // Message: server received : (ADDGROUP, new_group_name, null).
			    //          visitor received : (ADDGROUP, new_group_info, group_list) 

	REMOVEGROUP = 11,   // Message: server received : (REMOVEGROUP, to_remove_group_ID, null).
			    //          visitor received : (REMOVEGROUP, removed_group_ID, remaininggroup_list) 
	...
	SYNCHRONIZE = 13,   // Message: server received : (SYNCHRONIZED, null, null).
			    //          visitor received : (SYNCHRONIZED, null, group_list) 
			   
	CHANGEGROUP = 14,   // Message: server received : ( CHANGEGROUP, to_gId, null)
			    //	        visitor received: ( CHANGEGROUP, visitor_info, to_group_visitors)
			    ...
			    //    and the other visitors will either delete or add the requester to or from
			    //	  their visitor list.
	...
	LOGIN   = 2,	    // Message: Server received : (LOGIN, group_id, login_visitor_name)
			    ...
			    //   When client software received login body, it uses grou_visitor_list
