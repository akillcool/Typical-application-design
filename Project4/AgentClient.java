...
public class AgentClient extends JApplet {
    ...
    JButton     btnChangeGroup  = new JButton("Change Group");
	...
	*/
	...
	tfNameMsg[0].addActionListener( new ActionListener() {
		...
		//sendMessage( new Message( Message.AGENTLOGIN, groupID+"", visitorName ));
